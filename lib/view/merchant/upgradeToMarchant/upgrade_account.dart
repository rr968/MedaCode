                      ...
                      for (int i = 0; i < uploadedFiles.length; i++)
                        Padding(
                          padding: EdgeInsets.symmetric(
                              horizontal: screenWidth * .07, vertical: 10),
                          child: Column(
                            children: [
                              Row(
                                mainAxisAlignment:
                            ...
                            for (int i = 0; i < uploadedFiles.length; i++) {
                              ...
                              if (uploadresponse.statusCode == 200) {
                                ...
                                if (uploaddata["status"] == "success") {
                                  ...
                                  String document_name = uploadedFiles[i][0];
                                  counter -= 1;
                                  /////////////////
                                  ...
                                  if (counter == 0) {
                                    ...
                                    var request = http.Request('GET', Uri.parse(
                                        ...
                                        '$baseUrl/upgrade.php?input_key=$input_key&input_secret=$input_secret&user_id=$userId&subject_id=$userId&apprej=2&NI_id=${niid.text}&STJ_VAT=${vatNumber.text}&STejari=${comReg.text}&firm=${firmName.text}'));
                                    ...
                                    if (response.statusCode == 200) {
                                      Map data = json.decode(await response
                                          .stream
                                          .bytesToString());
                                      log(data.toString());
                        ...
                        onTap: () async {
                          ...
                          if (pickedFile != null) {
                            ...
                            if (fileExtension == 'png' ||
                              ...
                              setState(() {
                                uploadedFiles
                                    .add([pickedFile.name, pickedFile.path]);
                              });
                            } else {
